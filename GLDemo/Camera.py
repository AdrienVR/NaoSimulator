...
class Camera:
    ...
    def translateSceneRightAndUp( self, delta_x_pixels, delta_y_pixels ):
        ...
        #has been reduced to z axis//19/01/14
        self.position.coordinates[1] = self.position.coordinates[1] + translation.coordinates[1]
        self.target.coordinates[1] = self.target.coordinates[1] + translation.coordinates[1]
